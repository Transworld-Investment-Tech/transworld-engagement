...
export async function assembleSignedPdf({ originalBytes, document, signatories }) {
  ...
  // The original document's fingerprint — computed BEFORE we add or stamp any
  // page (a file cannot contain its own final hash). Printed in full on the
  // certificate and as a matchable fragment in every page's binding stamp.
