...
<p style="margin:0 0 16px;">A certificate of completion has been recorded with a tamper-evidence checkmark for your protection. Please keep this confirmation for your records; a signed copy can be provided by your Transworld contact on request.</p>
<p style="margin:24px 0 0;">Warm regards,<br>The Transworld Team</p>`;
  return {
    subject,
    html: renderEmailHtml({ subject, bodyHtml, preheader: `${documentTitle} is fully signed.` }),
  };
}
